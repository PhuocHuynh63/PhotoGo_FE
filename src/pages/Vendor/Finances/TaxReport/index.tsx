...
export default function TaxReports({ reports }: TaxReportsProps) {
    ...
    return (
        <Card className="bg-white">
            <CardHeader className="pb-2">
                <CardTitle className="text-lg font-medium">Báo cáo thuế</CardTitle>
                <p className="text-sm text-gray-500">Tải xuống báo cáo thuế theo quý</p>
            </CardHeader>
            <CardContent>

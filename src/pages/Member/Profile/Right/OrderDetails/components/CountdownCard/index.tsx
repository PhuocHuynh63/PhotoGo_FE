...
const CountdownCard: React.FC<CountdownCardProps> = ({ isVisible, targetDate }) => {
    ...
    return (
        ...
        >
            <h3 className="text-2xl font-bold mb-2 text-gray-800">Buổi chụp của bạn sắp diễn ra!</h3>
            <p className="text-gray-500 mb-6">Chúng tôi rất mong được đón tiếp bạn.</p>

                ...
                <div className="container mx-auto px-4">
                    <div className="flex flex-col gap-8">
                        <div className="text-center">
                            ...
                            <p className="text-gray-600">Chỉ với 4 bước đơn giản, bạn đã có thể đặt lịch chụp ảnh dễ dàng</p>
                        </div>

                        <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
                            <div className="flex flex-col items-center text-center gap-4">
                                <div className="w-12 h-12 rounded-full bg-orange-100 flex items-center justify-center text-orange-500">1</div>
                ...
                <div className="container mx-auto px-4">
                    <div className="flex flex-col gap-8">
                        <div className="text-center">
                            ...
                            <p className="text-gray-600">Hãy xem họ nói gì về chúng tôi</p>
                        </div>
